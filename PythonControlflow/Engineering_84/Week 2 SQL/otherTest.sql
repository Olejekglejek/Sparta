...
SELECT e.Title, COUNT(e.EmployeeID) AS 'Number of Employees'
FROM Employees e
GROUP BY e.Title
...
*/
SELECT c.CustomerID, COUNT(o.OrderID) AS 'NumOrder'
FROM Customers c
JOIN Orders o ON c.CustomerID = o.CustomerID
WHERE o.OrderDate > '31-Dec-1996'
...
SELECT e.TitleOfCourtesy, e.FirstName, e.LastName
FROM Employees e WHERE e.TitleOfCourtesy LIKE ('M_.')
